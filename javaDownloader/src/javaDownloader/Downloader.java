...
public class Downloader {
    ...
    public Downloader(String link, String fileName, long length){
        /*
        params:
        link            ->      the url to the file!
        fileName        ->      the name of the file to be downloaded!
    ...
    public void download(){
        /*
        Downloading Thread for android <= 9!
    ...
    public void download(OutputStream out, InputStream in){
        /*
        Downloading Thread for android > 9
        Retries every 3000 milliseconds in case of error!
         */
